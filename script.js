...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================
    // BƯỚC 1: HÀM KHỞI TẠO CHÍNH (ĐÃ ĐƯỢC XÁC MINH)
    // ==========================================================
    async function run() {
        try {
            ...
            await Promise.all([
                createImagePromise(hatImage, 'https://raw.githubusercontent.com/mrngovancouong-cyber/image-data/refs/heads/main/birthdayhat.png'),
                createImagePromise(candleImages[0], 'https://raw.githubusercontent.com/mrngovancouong-cyber/image-data/refs/heads/main/candleb1.png'),
                createImagePromise(candleImages[1], 'https://raw.githubusercontent.com/mrngovancouong-cyber/image-data/refs/heads/main/candelb2.png')
            ]);
    ...
    // ==========================================================
    // BƯỚC 2: VÒNG LẶP GAME (KHÔI PHỤC LOGIC GAME)
    // ==========================================================
    async function gameLoop() {
        ...
        // Logic game CHỈ chạy khi game đang hoạt động
        if (gameActive) {
        ...
        // Vẽ khuôn mặt luôn chạy để người chơi thấy mình
        if (detections && detections.length > 0) {
    ...
    // ==========================================================
    // KHÔI PHỤC CÁC HÀM QUẢN LÝ GAME
    // ==========================================================
    function startGame() {
